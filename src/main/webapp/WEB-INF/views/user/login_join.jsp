...
<body>
	...
	<div class="common_container">
		<div id="main_frame">
			<form action="/login_join" method="post" class="join">
				<div id="blank"></div>
				<fieldset>
					<br>
					<br>
					<div id="content">아이디, 이메일, 비밀번호를 작성하세요.</div>
					<br>
					<br> <input type="text" id="id" name="u_id" size=46
						placeholder="아이디"><br>
					<br> <input type="text" id="name" name="u_name" size=46
						placeholder="이름"><br>
					<br> <input type="text" id="email" name="u_email" size=46
						placeholder="이메일(kim@example.com)"><br>
					<br> <input type="password" id="pw" name="u_pwd1" size=46
						placeholder="비밀번호"><br>
					<br> <input type="password" id="pw2" name="pw2" size=46
						placeholder="비밀번호 확인"><br>
					<br> <input type="submit" value="회원가입" class="submit">
				</fieldset>
				<br>
				<div>회원가입을 했을 시 약관에 동의한 것으로 간주됩니다.</div>
				<br>
				<!-- 
			<fieldset>
			...
			<br> -->
				<div>
					이미 계정이 있나요? <a href="login" class="alink">로그인</a>
				</div>
				<div id="blank3"></div>
			</form>
		</div>
