	...
	<div id="main_frame">
		<form action="/login_join" method="post" class="join">
			...
			<fieldset>
				...
				<input type="text" id="id" name="u_id" size=46 placeholder="아이디"><br><br>
				<input type="text" id="name" name="u_name" size=46 placeholder="이름"><br><br>
				<input type="text" id="email" name="u_email" size=46 placeholder="이메일(kim@example.com)"><br><br>
				<input type="password" id="pw" name="u_pwd1" size=46 placeholder="비밀번호"><br><br>
